...
ActiveRecord::Schema.define(version: 20180715140745) do
  ...
  create_table "children", force: :cascade do |t|
    ...
    t.integer "crew_leader_id"
    t.index ["crew_leader_id"], name: "index_children_on_crew_leader_id"
    t.index ["parent_id"], name: "index_children_on_parent_id"
  end

  create_table "crew_leaders", force: :cascade do |t|
    t.string "first_name"
    t.string "last_name"
    t.string "phone"
    t.string "email"
